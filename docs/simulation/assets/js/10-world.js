...
(function (NS) {
  ...
  function OwnShip(world, cfg) {
    ...
    /* Set by the world model — the helm never decides anything
  ...
  OwnShip.prototype.step = function (dt, world) {
    const c = this.cfg, g = this.guidance;
    NS.navigation.advance(this, world.waterway,
      g && g.targetOffset !== undefined ? g.targetOffset : c.laneOffset,
      g ? g.speedFactor : 1, dt);
    const here = {s:this.stationEstimate};
